    ...
    <header className="hero">
      ...
      <div className="hero-boxes">
        <div className="box top-left">
          <img src={images[currentIndex]} alt="Cuadro 1" className={fade ? 'fade' : ''} />
        </div>
        <div className="box top-right">
          <img src={images[(currentIndex + 1) % images.length]} alt="Cuadro 2" className={fade ? 'fade' : ''} />
        </div>
        <div className="box bottom-left">
          <img src={images[(currentIndex + 2) % images.length]} alt="Cuadro 3" className={fade ? 'fade' : ''} />
        </div>
        <div className="box bottom-right">
          <img src={images[(currentIndex + 3) % images.length]} alt="Cuadro 4" className={fade ? 'fade' : ''} />
        </div>
      </div>

      <div className="hero-overlay">
        <h1>Bienvenido a la app de Reservaciones</h1>
